...
<head>
    ...
    <!-- Custom CSS -->
     ...
     body {
        ...
        .navbar-brand i {
            animation: bounce 1s infinite; /* Apply animation to the envelope icon */
        }

        /* Define the bounce animation */
        @keyframes bounce {
            0%, 20%, 50%, 80%, 100% {
                transform: translateY(0); /* Apply no vertical movement at these points */
            }
            40% {
                transform: translateY(-10px); /* Apply upward movement at 40% */
            }
            60% {
                transform: translateY(-5px); /* Apply slight upward movement at 60% */
            }
        }

        /* Other styles remain the same as your original code */
        .card {
             ...
             <div class="col-md-6">
                 <div class="row justify-content-center">
                     <div class="col-md-8 col-lg-7 col-xl-6">
                        <form id="loginForm" runat="server" method="post" onsubmit="return validateForm();">
                             <div class="form-group">
                                 <asp:RequiredFieldValidator ID="rfvUsername" runat="server" ControlToValidate="username" ErrorMessage="(Username is required)" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                 <br />
                                 <asp:Label ID="lblUsernameError" runat="server" Text="Username is required" ForeColor="Red" Visible="false"></asp:Label>
                             ...
                             <div class="form-group">
                                 <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ControlToValidate="password" ErrorMessage="(Password is required)" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                 <br />
                                 <asp:Label ID="lblPasswordError" runat="server" Text="Password is required" ForeColor="Red" Visible="false"></asp:Label>
                                 <label for="password">Password</label>
                                 <asp:TextBox ID="password" runat="server" TextMode="Password" CssClass="form-control" placeholder="Enter Password" ></asp:TextBox>
                                 <br />
                             </div>
                             <div class="form-group">
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.6.1/js/bootstrap.min.js"></script>
     ...
     <script>
         function validateForm() {
            ...
            document.getElementById('<%= lblUsernameError.ClientID %>').style.display = 'none';
            document.getElementById('<%= lblPasswordError.ClientID %>').style.display = 'none';
            document.getElementById('<%= errorMessage.ClientID %>').innerText = '';

            // Validate username
            if (username.trim() === '') {
                document.getElementById('<%= lblUsernameError.ClientID %>').style.display = 'block';
                return false;
            }
