...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                <h3 class="compose-title">Compose</h3> <!-- Apply the compose-title class to the title -->
                <form>
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="toEmail" runat="server" CssClass="form-control" placeholder="Enter recipient email"></asp:TextBox>
                                 <asp:Label ID="errtoEmail" BorderColor="Red" runat="server" Text=""></asp:Label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:Label ID="errtoCC" BorderColor="Red" runat="server" Text=""></asp:Label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="toBCC" runat="server" CssClass="form-control" placeholder="Enter recipient email"></asp:TextBox>
                                  <asp:Label ID="errtoBCC" BorderColor="Red" runat="server" Text=""></asp:Label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtmessage" runat="server" TextMode="MultiLine" Rows="5" CssClass="form-control" placeholder="Compose mail to your loved ones..."></asp:TextBox>
                    </div>
